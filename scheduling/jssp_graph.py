...
from formats import JSSPInstance, INF
...
class JSSPGraph:
    ...
    def __init__(self,
        ...
        c = np.eye(self.graph_size, k=1, dtype=np.int64)
        ...
        if init_disjunctions:
            d = np.zeros((self.graph_size, self.graph_size), dtype=np.int64)
        ...
        temp = c == 1
        self._job_graph_w = weights[temp].astype(np.single)
